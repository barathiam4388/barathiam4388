...
💡 **Disponible pour des entrevues dès maintenant et pour un poste junior à partir de juillet 2026 !**
...
| :--- | :--- |
| **Langages** | C#, PHP, JavaScript, TypeScript, Python, Java, SQL, HTML5 / CSS3 |
| **Frameworks & Libs** | .NET (Windows Forms), Next.js, Flask, Node/Express, Tailwind CSS, AJAX |
| **CMS & CRM** | WordPress, WooCommerce, GoHighLevel, Lovable |
| **Bases de données** | SQL Server (SSMS), MySQL, SQLite, JSON |
| **Outils & Méthodes** | Git / GitHub, Visual Studio, VS Code, Figma, ClickUp, architecture MVC, API REST |
...
*   **[BookManager](https://github.com)** : Lecteur numérique avec interface graphique (.NET, C#).
*   **[QueueCare](https://github.com)** : Système de rendez-vous en console avec persistance (C#, JSON).
